            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div class="p-6 transition-shadow border border-blue-200 rounded-lg bg-blue-50 dark:bg-blue-900/20 dark:border-blue-800 hover:shadow-md">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Karyawan</h3>
                            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $countByPosition['karyawan'] }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 transition-shadow border border-yellow-200 rounded-lg bg-yellow-50 dark:bg-yellow-900/20 dark:border-yellow-800 hover:shadow-md">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ $countByPosition['barista'] }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 transition-shadow border border-green-200 rounded-lg bg-green-50 dark:bg-green-900/20 dark:border-green-800 hover:shadow-md">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $countByPosition['kasir'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="w-full sm:w-48">
                            ...
                            <div class="relative">
                                <select id="filter_posisi" name="filter_posisi"
                                    ...
                                    <option value="karyawan" {{ request('filter_posisi') == 'karyawan' ? 'selected' : '' }}>Karyawan</option>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full
                                            @if($k->posisi == 'barista') bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-400
