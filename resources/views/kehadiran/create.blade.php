<x-admin-layout>
    ...
    <div class="p-6">
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Tambah Kehadiran</h2>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Catat kehadiran karyawan cafe</p>
                        </div>
            ...
            <!-- Main Form -->
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <form action="{{ route('kehadiran.store') }}" method="POST" class="space-y-6 p-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" id="keterangan" rows="3"
                            ...
                            class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 resize-none">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="text-sm text-blue-700 dark:text-blue-400">
                        <h4 class="font-medium">Informasi Pengisian:</h4>
                        <ul class="mt-2 list-disc list-inside space-y-1">
                            <li>Pilih karyawan yang akan dicatat kehadirannya</li>
                            <li>Jam masuk dan keluar akan muncul jika status "Hadir"</li>
                            <li>Untuk status "Tidak Hadir", "Izin", atau "Sakit", jam tidak perlu diisi</li>
                            <li>Keterangan bersifat opsional untuk menambahkan catatan khusus</li>
                        </ul>
                    </div>
                </div>
            </div>
